...
function B = jbfilter2(A,Guidance,w,sigma)
...
if size(A,3) == 1
   B = bfltGray(A,Guidance,w,sigma(1),sigma(2));
else
   B = bfltColor(A,Guidance,w,sigma(1),sigma(2));
end


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Implements bilateral filtering for grayscale images.
function B = bfltGray(A,Guidance,w,sigma_d,sigma_r)
...
function B = bfltColor(A,Guidance,w,sigma_d,sigma_r)
